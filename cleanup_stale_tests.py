#!/usr/bin/env python3
"""Clean up stale test files that don't match existing parser modules."""
...
def cleanup_stale_tests(
    ...
    notebooks_tests_dir: str | Path | None = "notebooks/time_parser/tests",
) -> None:
    ...
    # Get all test files from both locations
...
if __name__ == "__main__":
    ...
    print("Checking time_parser/parsers and time_parser/tests...")
    cleanup_stale_tests("time_parser/parsers", "time_parser/tests")
    
    print("\n" + "="*70)
    print("Checking notebooks/time_parser/parsers and notebooks/time_parser/tests...")
    cleanup_stale_tests("notebooks/time_parser/parsers", "notebooks/time_parser/tests")
